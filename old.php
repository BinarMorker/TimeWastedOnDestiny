    ...
    <div class="container vert-middle">
            ...
            <div class="col-sm-6">
                <div class="panel panel-warning">
                    ...
                    <table class="table table-condensed table-striped">
                        ...
                        <tbody>
                            <?php
                            $request = file_get_contents("http://" . $_SERVER['HTTP_HOST'] . "/api?leaderboard");
                            ...
                            <tr>
                                <td><?=$count?></td>
                                <td><img width="20" height="20" src="/img/<?=$image?>-icon-black.svg" />&nbsp;<a href="/old/<?=$image?>/<?=strtolower($row->displayName)?>"><?=$row->displayName?></a></td>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <br/>
                <span class="text-muted">You can also use my simple API located <a href="/api?help">here</a>.</span>
                <br/>
				...
				<br/>
				<h4><a href="/">Go to the new website!</a></h4>
            </div>
        </div>
    </div>
    <!-- JavaScript -->
